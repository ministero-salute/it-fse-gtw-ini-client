...
import static it.finanze.sanita.fse2.ms.iniclient.config.Constants.Profile.*;
...
class ConfigClientTest {
    ...
    private static final ConfigItemTypeEnum specific = ConfigItemTypeEnum.INI_CLIENT;
