...
public interface IIniClient {
	...
	RegistryResponseType sendPublicationData(DocumentEntryDTO documentEntryDTO, SubmissionSetEntryDTO submissionSetEntryDTO, JWTTokenDTO jwtTokenDTO,
			String workflowInstanceId,Date startingDate, String edsPublished);
  ...
  JWTTokenDTO jwtTokenDTO, String uuid,String workflowInstanceId,Date startingDate, String edsPublished);
    ...
    RegistryResponseType sendOscuramentoData(DocumentEntryDTO documentEntryDTO, SubmissionSetEntryDTO submissionSetEntryDTO, final JWTTokenDTO jwtTokenDTO,
