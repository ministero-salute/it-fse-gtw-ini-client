...
@Slf4j
public final class PublishBodyBuilderUtility {
	 ...
	 * @return
	 */
	public static SubmitObjectsRequest buildSubmitObjectRequest(DocumentEntryDTO documentEntryDTO,SubmissionSetEntryDTO submissionSetEntryDTO, JWTPayloadDTO jwtPayloadDTO) {
		SubmitObjectsRequest submitObjectsRequest = new SubmitObjectsRequest();
		try {
			RegistryObjectListType registryObjectListType = buildRegistryObjectList(documentEntryDTO, submissionSetEntryDTO, jwtPayloadDTO);
	 ...
	 * @return
	 */
	private static RegistryObjectListType buildRegistryObjectList(DocumentEntryDTO documentEntryDTO,SubmissionSetEntryDTO submissionSetEntryDTO,JWTPayloadDTO jwtPayloadDTO) {
		...
		try {
			...
			JAXBElement<AssociationType1> associationObject = buildAssociationObject("urn:oasis:names:tc:ebxml-regrep:AssociationType:HasMember","SubmissionSet01_Association_1", "SubmissionSet01","urn:uuid:" + requestUUID, associationObjectSlots);
