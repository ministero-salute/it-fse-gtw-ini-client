...
public enum ActionEnumType {
	...
	UPDATE_V2(Constants.IniClientConstants.UPDATE_ACTION, Constants.IniClientConstants.TREATMENT_PURPOSE_OF_USE,
			Constants.IniClientConstants.UPDATE_SETB_ACTION),
