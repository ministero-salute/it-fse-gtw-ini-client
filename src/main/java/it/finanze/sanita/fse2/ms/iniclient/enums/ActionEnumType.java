...
public enum ActionEnumType {
    ...
    READ_METADATA(Constants.IniClientConstants.READ_ACTION, Constants.IniClientConstants.UPDATE_PURPOSE_OF_USE,Constants.IniClientConstants.REGISTRY_STORED_QUERY_ACTION),
